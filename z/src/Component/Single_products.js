                                        ...
                                        <div className="swiper-container" style={{ zIndex: "0" }}>
                                            <div className="swiper-wrapper">
                                                <div className="swiper-slide gallery-thumbs-item">
                                                    <a href="#?">
                                                        <img src="assets/images/products/product-1.jpg" alt="image_not_found" />
                                                    </a>
                                                </div>
                                                <div className="swiper-slide gallery-thumbs-item">
                            ...
                            <div className="col-md-7 mb-7">
                                <div className="modal-product-des">
                                    ...
                                    <div className="product-description-short pb-7 mb-7">
                                        <ul>
                                            <li>
                                                Score extra points when it comes to your sporty look with the Juicy Couture™ Juicy Quilted
                                                Terry
                                                Track Jacket.
                                            </li>
                                            <li>
